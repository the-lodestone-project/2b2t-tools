...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [1195],
  {
    ...
    64998: function (e, t, n) {
      ...
      var r = n(84297);
      let i = (0, r.Z)("ChevronRight", [
        ["path", { d: "m9 18 6-6-6-6", key: "mthhwq" }],
      ]);
    },
    45077: function (e, t, n) {
      n.d(t, {
        Z: function () {
          return i;
        },
    ...
    95067: function (e, t, n) {
      ...
      var r = n(84297);
      let i = (0, r.Z)("LineChart", [
        ["path", { d: "M3 3v18h18", key: "1s2lah" }],
        ["path", { d: "m19 9-5 5-4-4-3 3", key: "2osh9i" }],
      ]);
    },
    76952: function (e, t, n) {
      n.d(t, {
        Z: function () {
          return i;
        },
    ...
    67338: function (e, t, n) {
      ...
      var r = n(84297);
      let i = (0, r.Z)("Terminal", [
        ["polyline", { points: "4 17 10 11 4 5", key: "akl6gq" }],
        ["line", { x1: "12", x2: "20", y1: "19", y2: "19", key: "q2wloq" }],
      ]);
    },
    43777: function (e, t, n) {
      n.d(t, {
        Z: function () {
          return i;
        },
            ...
            var t = Object.keys(e)
                ...
                .map(function (t) {
                  ...
                  return (
                    ...
                    ("root" === t
                      ? (n = e.root)
                        ? (o.has(n) || ((l += 1), o.set(n, l.toString())),
                          o.get(n))
                        : "0"
                      : e[t])
                  );
        ...
        return (
          ...
          function () {
            f.splice(f.indexOf(t), 1),
              0 === f.length && (h.delete(e), d.unobserve(e)),
              0 === h.size && (d.disconnect(), i.delete(c));
          }
        );
      }
      var a = [
          ...
          return (
            ...
            (n.handleChange = function (e, t) {
              e && n.props.triggerOnce && n.unobserve(),
                isPlainChildren(n.props) || n.setState({ inView: e, entry: t }),
        ...
        return (
          ...
          (t.render = function () {
            ...
            return r.createElement(
              l || "div",
              _extends({ ref: this.handleNode }, s),
              o,
            );
          }),
          InView
      ...
      function useInView(e) {
        var t = void 0 === e ? {} : e,
          ...
          g = r.useCallback(
            ...
            [Array.isArray(n) ? n.toString() : n, s, l, a, u, o, d, i],
          );
        (0, r.useEffect)(function () {
          h.current || !p.entry || a || u || y({ inView: !!c });
        });
        var v = [g, p.inView, p.entry];
        return (v.ref = v[0]), (v.inView = v[1]), (v.entry = v[2]), v;
      }
      (u.displayName = "InView"),
      ...
      let notify = (e) => !e.isLayoutDirty && e.willUpdate(!1),
        ...
        LayoutGroup = ({ children: e, id: t, inherit: n = !0 }) => {
          let s = (0, r.useContext)(i.p),
            ...
            h = s.id || a;
          null === d.current &&
            (shouldInheritId(n) && h && (t = t ? h + "-" + t : h),
            (d.current = {
              id: t,
              group:
                (shouldInheritGroup(n) && s.group) ||
                (function () {
                  let e = new Set(),
                    t = new WeakMap(),
          ...
          let f = (0, r.useMemo)(() => ({ ...d.current, forceRender: u }), [c]);
          return r.createElement(i.p.Provider, { value: f }, e);
        };
    },
    ...
    79645: function (e, t, n) {
      ...
      function updateAxisInfo(e, t, n, r) {
        ...
        let u = r - a;
        i.velocity = u > 50 ? 0 : (0, f.R)(i.current - s, u);
      }
      let y = {
          All: [
            [0, 0],
      ...
      function useScroll({
        ...
        let a = (0, l.h)(createScrollMotionValues),
          h = n ? I.L : s.useEffect;
        return (
          h(
            () => (
              ...
              (function (
                ...
                let o = M.get(t);
                o || ((o = new Set()), M.set(t, o));
                let l = createScrollInfo(),
                  s = (function (e, t, n, r = {}) {
                    return {
                      measure: () =>
                        (function (e, t = e, n) {
                        ...
                        updateAxisInfo(e, "x", n, t),
                          ...
                          (r.offset || r.target) &&
                            (function (e, t, n) {
                              ...
                              c &&
                                ((t[o].interpolate = (0, k.s)(
                                  t[o].offset,
                                  (0, w.Y)(r),
                                )),
                                (t[o].interpolatorOffsets = [...t[o].offset])),
                                (t[o].progress = t[o].interpolate(
                                  t[o].current,
                                ));
                            })(e, n, r);
                      },
                ...
                if ((o.add(s), !x.has(t))) {
                  let measureAll = () => {
                    ...
                    listener = () => {
                      b.Wi.read(measureAll, !1, !0),
                        b.Wi.update(updateAll, !1, !0),
                        b.Wi.update(notifyAll, !1, !0);
                    };
                  x.set(t, listener);
          ...
          "function" == typeof t
            ...
            : (function (...e) {
                let t = !Array.isArray(e[0]),
                  ...
                  l = e[2 + n],
                  s = e[3 + n],
                  a = (0, r.s)(o, l, { mixer: getMixer(l[0]), ...s });
                return t ? a(i) : a;
              })(t, n, i);
        return Array.isArray(e)
          ? useListTransform(e, o)
          : useListTransform([e], ([e]) => o(e));
      }
