(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [1766],
  {
    41766: function (e, t, n) {
      var o, r, i, a, s, u, d, _, l, c, p, f, h, m, v;
      ((r = function () {
        this.init();
      }).prototype = {
        init: function () {
        ...
        _setupCodecs: function () {
          ...
          var n = t.canPlayType("audio/mpeg;").replace(/^no$/, ""),
            ...
            r = o.match(/OPR\/([0-6].)/g),
            a = r && 33 > parseInt(r[0].split("/")[1], 10),
            ...
            var unlock = function (t) {
              ...
              for (var o = 0; o < e._howls.length; o++)
                if (!e._howls[o]._webAudio)
                  for (
                    var r = e._howls[o]._getSoundIds(), i = 0;
                    i < r.length;
                    i++
                  ) {
                    var a = e._howls[o]._soundById(r[i]);
                    a &&
                      a._node &&
                      !a._node._unlocked &&
            ...
            return (
              ...
              (e._suspendTimer = setTimeout(function () {
                if (e.autoSuspend) {
                  ...
                  e.ctx.suspend().then(handleSuspension, handleSuspension);
                }
              }, 3e4)),
              e
            );
        ...
        ((a = function (e) {
          ...
          load: function () {
            ...
            for (var o = 0; o < this._src.length; o++) {
              if (this._format && this._format[o]) e = this._format[o];
              else {
                if ("string" != typeof (t = this._src[o])) {
                  this._emit(
                    "loaderror",
                    null,
          ...
          play: function (e, t) {
            ...
            if (!s) return null;
            if (
              (o && !e && (e = s._sprite || "__default"), "loaded" !== n._state)
            ) {
            ...
            if (n._webAudio) {
              var playWebAudio = function () {
                (n._playLock = !1), setParams(), n._refreshBuffer(s);
                ...
                f.gain.setValueAtTime(e, i.ctx.currentTime),
                  ...
                  void 0 === f.bufferSource.start
                    ? s._loop
                      ? f.bufferSource.noteGrainOn(0, d, 86400)
                      : f.bufferSource.noteGrainOn(0, d, _)
                    : s._loop
                      ? f.bufferSource.start(0, d, 86400)
                      : f.bufferSource.start(0, d, _),
                  l !== 1 / 0 &&
              ...
              "running" === i.state && "interrupted" !== i.ctx.state
                ? playWebAudio()
                : ((n._playLock = !0),
                  n.once("resume", playWebAudio),
                  n._clearTimer(s._id));
            } else {
              var playHtml5 = function () {
                (f.currentTime = d),
                  (f.muted = s._muted || n._muted || i._muted || f.muted),
                  (f.volume = s._volume * i.volume()),
              ...
              var h =
                ...
                (!f.readyState && i._navigator.isCocoonJS);
              if (f.readyState >= 3 || h) playHtml5();
              else {
                (n._playLock = !0), (n._state = "loading");
                var listener = function () {
                  (n._state = "loaded"),
                    playHtml5(),
                    f.removeEventListener(i._canPlayEvent, listener, !1);
                };
                f.addEventListener(i._canPlayEvent, listener, !1),
                  n._clearTimer(s._id);
              }
            }
            return s._id;
          ...
          rate: function () {
            ...
            for (var a = 0; a < t.length; a++)
              if ((n = o._soundById(t[a]))) {
                o.playing(t[a]) &&
                  ((n._rateSeek = o.seek(t[a])),
                  ...
                  u =
                    (1e3 *
                      ((o._sprite[n._sprite][0] + o._sprite[n._sprite][1]) /
                        ...
                        s)) /
                    Math.abs(n._rate);
                (o._endTimers[t[a]] || !n._paused) &&
                  (o._clearTimer(t[a]),
                  (o._endTimers[t[a]] = setTimeout(o._ended.bind(o, n), u))),
                  o._emit("rate", n._id);
              }
            return o;
          },
          seek: function () {
            ...
            if (r) {
              if ("number" == typeof e && e >= 0) {
                ...
                if (!n._webAudio) return r._node.currentTime;
                var s = n.playing(t) ? i.ctx.currentTime - r._playStart : 0,
                  u = r._rateSeek ? r._rateSeek - r._seek : 0;
                return r._seek + (u + s * Math.abs(r._rate));
              }
            }
            return n;
          },
        ...
        ((s = function (e) {
          ...
          _loadListener: function () {
            ...
            (e._duration = Math.ceil(10 * this._node.duration) / 10),
              ...
              this._node.removeEventListener(i._canPlayEvent, this._loadFn, !1);
          },
        ...
        (l = function (e, t) {
          var error = function () {
            ...
            success = function (e) {
              e && t._sounds.length > 0 ? ((u[t._src] = e), c(t, e)) : error();
            };
          "undefined" != typeof Promise && 1 === i.ctx.decodeAudioData.length
            ? i.ctx.decodeAudioData(e).then(success).catch(error)
            : i.ctx.decodeAudioData(e, success, error);
        }),
        (c = function (e, t) {
              ...
              (a._stereo = e),
                ...
                a._node &&
                  ...
                  "spatial" === o
                    ...
                    : a._panner.pan.setValueAtTime(e, Howler.ctx.currentTime)),
        ...
        (Howl.prototype.pos = function (e, t, n, o) {
          ...
          for (var i = r._getSoundIds(o), a = 0; a < i.length; a++) {
            ...
            if (s) {
              ...
              (s._pos = [e, t, n]),
                s._node &&
                  ((!s._panner || s._panner.pan) && v(s, "spatial"),
        ...
        (Howl.prototype.pannerAttr = function () {
          ...
          if (1 === o.length) {
            if ("object" != typeof o[0])
              return (n = this._soundById(parseInt(o[0], 10)))
                ? n._pannerAttr
                : this._pannerAttr;
            (e = o[0]),
              void 0 === t &&
              ...
              a = {
                ...
                distanceModel:
                  void 0 !== e.distanceModel
                    ...
                    : a.distanceModel,
                maxDistance:
                  void 0 !== e.maxDistance ? e.maxDistance : a.maxDistance,
                refDistance:
                  void 0 !== e.refDistance ? e.refDistance : a.refDistance,
                rolloffFactor:
                  void 0 !== e.rolloffFactor
                    ? e.rolloffFactor
                    : a.rolloffFactor,
                panningModel:
                  void 0 !== e.panningModel ? e.panningModel : a.panningModel,
              };
              var s = n._panner;
              s
